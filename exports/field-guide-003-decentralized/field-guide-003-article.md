...
[Field Guide 004: Autonomous](https://falsedawn.industries/field-guide-004) is live now — agent-to-agent marketplaces, the growth-curve dynamics, and what it means to market to machines at scale. Pressure-test the thinking against working code at [github.com/jratlee/FDI](https://github.com/jratlee/FDI).
