...
This application is powered by the math inside `<a href="https://github.com/ESeufert/theseus_growth">theseus_growth</a>`, originally created by mobile growth expert Eric Seufert. While the original software was a powerful Python library built for data scientists, this interface democratizes that complex "cohort compounding" math so anyone can use it. 
