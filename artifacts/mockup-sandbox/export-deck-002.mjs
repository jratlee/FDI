...
const URL = "http://localhost:23636/__mockup/deck/field-guide-002-deck.html";
...
await page.pdf({
  path: path.join(OUT, "fdi-field-guide-002-deck.pdf"),
  printBackground: true,
  preferCSSPageSize: true,
});
console.log("PDF: fdi-field-guide-002-deck.pdf");
