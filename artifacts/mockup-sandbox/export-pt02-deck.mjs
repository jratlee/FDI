...
const URL = "http://localhost:23636/__mockup/deck/fdcp-deck.html";
const OUT = path.resolve(import.meta.dirname, "../../exports/performance-thinking-02");
const SLIDES = 12;
...
await page.pdf({
  path: path.join(OUT, "fdi-fdcp-deck.pdf"),
  printBackground: true,
  preferCSSPageSize: true,
});
console.log("PDF: fdi-fdcp-deck.pdf");
