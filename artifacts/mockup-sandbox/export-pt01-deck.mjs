...
const URL = "http://localhost:23636/__mockup/deck/performance-thinking-01-deck.html";
const OUT = path.resolve(import.meta.dirname, "../../exports/performance-thinking-01");
const SLIDES = 12;
...
await page.pdf({
  path: path.join(OUT, "fdi-performance-thinking-01-deck.pdf"),
  printBackground: true,
  preferCSSPageSize: true,
});
console.log("PDF: fdi-performance-thinking-01-deck.pdf");
