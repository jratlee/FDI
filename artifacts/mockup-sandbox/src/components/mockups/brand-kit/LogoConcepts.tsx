...
const ConceptCard = ({ title, description, Mark }: ConceptCardProps) => {
  return (
    <div className="flex flex-col border border-solid" style={{ borderColor: COLORS.borderHairline, backgroundColor: COLORS.surface }}>
      <div className="p-8 border-b border-solid flex flex-col items-center justify-center min-h-[300px]" style={{ borderColor: COLORS.borderHairline }}>
        <Label>Primary Mark</Label>
        <div className="flex-1 flex items-center justify-center">
          <Mark size={120} color={COLORS.amber} />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-solid" style={{ borderColor: COLORS.borderHairline }}>
        <div className="p-8 flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center mt-4">
            <Mark size={48} color={COLORS.amber} />
        ...
        <div className="grid grid-rows-2 divide-y divide-solid" style={{ borderColor: COLORS.borderHairline }}>
          ...
          <div className="flex divide-x divide-solid" style={{ borderColor: COLORS.borderHairline }}>
            <div className="flex-1 p-6 flex flex-col items-center justify-center bg-black/20">
              ...
              <div className="mt-2">
                <Mark size={40} color={COLORS.amber} />
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen p-8 md:p-12 lg:p-24 w-full max-w-[1400px] mx-auto font-['Inter']" style={{ backgroundColor: COLORS.base, color: COLORS.textPrimary }}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 md:gap-12">
        ...
        />
        <ConceptCard 
          title="Concept 02: Horizon Dawn"
          description="A literal interpretation of the 'false dawn' — light breaking over a horizon line. The structural grid below the curve represents the foundational models driving the insights."
          Mark={HorizonMark}
        />
        <ConceptCard 
