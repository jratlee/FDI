...
const BING_SITE_VERIFICATION = (process.env.BING_SITE_VERIFICATION || "")
  .trim()
  .replace(/["<>]/g, "");
const MCP_URL = "https://modelcontextprotocol.io/docs/2026-07-28/getting-started/intro";
const AS_OF = "2026";
